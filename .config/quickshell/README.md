...
- Animated background (`AnimatedBackground.qml`) for Material 3; Nothing uses a static neutral fallback with a flat clock treatment, and Neo uses a static hard-edged fallback with a mechanical clock treatment
